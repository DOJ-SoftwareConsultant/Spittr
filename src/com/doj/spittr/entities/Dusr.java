...
public class Dusr  implements Serializable{
	...
	public Dusr(Long usrid, String usrfn, String usrln, String usreml,
			Date usrdob, String usrphn, String usraddr1, String usraddr2,
			Long usrcity, Long usrstate, Date createdate, Date modidate,
			Long photoid, String exfield1, Long exfield2, String isdeleted,
			String active) {
		super();
		this.usrid = usrid;
		this.usrfn = usrfn;
	...
	public int hashCode() {
		...
		result = prime * result
				+ ((usraddr1 == null) ? 0 : usraddr1.hashCode());
		result = prime * result
				+ ((usraddr2 == null) ? 0 : usraddr2.hashCode());
		...
		result = prime * result
				+ ((usrstate == null) ? 0 : usrstate.hashCode());
		return result;
	}
	...
	public String toString() {
		return "Dusr [usrid=" + usrid + ", usrfn=" + usrfn + ", usrln=" + usrln
				+ ", usreml=" + usreml + ", usrdob=" + usrdob + ", usrphn="
				+ usrphn + ", usraddr1=" + usraddr1 + ", usraddr2=" + usraddr2
				+ ", usrcity=" + usrcity + ", usrstate=" + usrstate
				+ ", createdate=" + createdate + ", modidate=" + modidate
				+ ", photoid=" + photoid + ", exfield1=" + exfield1
