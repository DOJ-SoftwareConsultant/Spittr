...
public class Dflwr implements Serializable{
	...
	public String getFlwrfollow() {
		return flwrfollow;
	}
	public void setFlwrfollow(String flwrfollow) {
		this.flwrfollow = flwrfollow;
	}
	...
	public Dflwr(Long flwrid, Long flwrusrid, String flwrfollow,
	...
	public int hashCode() {
		...
		result = prime * result
				+ ((flwrfollow == null) ? 0 : flwrfollow.hashCode());
	...
	public boolean equals(Object obj) {
		...
		if (exfield2 == null) {
			...
			return false;
		if (flwrfollow == null) {
			if (other.flwrfollow != null)
				return false;
		} else if (!flwrfollow.equals(other.flwrfollow))
			return false;
		if (flwrid == null) {
	...
	public String toString() {
		return "Dflwr [flwrid=" + flwrid + ", flwrusrid=" + flwrusrid
				+ ", flwrfollow=" + flwrfollow + ", createdate=" + createdate
