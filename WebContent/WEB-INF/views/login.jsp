			...
			<div class="logmod__container">
				...
				<div class="logmod__tab-wrapper">
								...
								<div class="sminputs">
									<div class="input string optional">
										<form:label path="usrpwd" class="string optional" >Password
											*</form:label> 
										<form:password path="usrpwd" maxlength="255" id="user-pw"
					...
					<div class="logmod__tab lgm-2">
						<div class="logmod__form">
							<form:form modelAttribute="dusr"  action="login" class="simform" method="post">
								<div class="sminputs">
									<div class="input full">
								...
								<div class="sminputs">
									...
									<div class="simform__actions">
										 <input
											...
											value="Log In" /> <span class="simform__actions-sidetext">
